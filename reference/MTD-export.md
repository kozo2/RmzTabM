...
- [`setMtdProtocol()`](https://rformassspectrometry.github.io/RmzTabM/reference/setMtdProtocol.md)/[`getMtdProtocol()`](https://rformassspectrometry.github.io/RmzTabM/reference/setMtdProtocol.md):
  set/get protocol Metadata in an MTD section.
...
- one assay is (generally) one sample, but the same sample can be
  measured with multiple assays (i.e., technical replicates).
...
#>  [5,] "description"                               
#>  [6,] "instrument[1]-name"                        
#>  [7,] "instrument[1]-source"                      
#>  [8,] "instrument[1]-analyzer[1]"                 
#>  [9,] "instrument[1]-detector"                    
#> [10,] "software[1]"                               
#> [11,] "contact[1]-name"                           
#> [12,] "contact[1]-affiliation"                    
#> [13,] "contact[1]-email"                          
#> [14,] "contact[1]-orcid"                          
#> [15,] "contact[2]-name"                           
#> [16,] "contact[2]-affiliation"                    
#> [17,] "contact[2]-email"                          
#> [18,] "contact[2]-orcid"                          
#> [19,] "quantification_method"                     
#> [20,] "cv[1]-label"                               
#> [21,] "cv[1]-full_name"                           
#> [22,] "cv[1]-version"                             
#> [23,] "cv[1]-uri"                                 
...
#> [31,] "cv[3]-uri"                                 
#> [32,] "database[1]"                               
#> [33,] "database[1]-prefix"                        
#> [34,] "database[1]-version"                       
#> [35,] "database[1]-uri"                           
#> [36,] "small_molecule-quantification_unit"        
#> [37,] "small_molecule_feature-quantification_unit"
#> [38,] "small_molecule-identification_reliability" 
#>       value                                                                    
#>  [1,] "2.1.0-M"                                                                
#>  [2,] "EXP_001"                                                                
#>  [3,] "M"                                                                      
#>  [4,] "Experiment 1 preprocessed data"                                         
#>  [5,] "The preprocessed data of experiment 1 samples."                         
#>  [6,] "[MS, MS:1000449, LTQ Orbitrap,]"                                        
#>  [7,] "[MS, MS:1000073, ESI,]"                                                 
#>  [8,] "[MS, MS:1000291, linear ion trap,]"                                     
#>  [9,] "[MS, MS:1000253, electron multiplier,]"                                 
#> [10,] "[,,[MS, MS:1001582], xcms, 4.0.0,]"                                     
#> [11,] "frodo"                                                                  
#> [12,] "fellowship of the ring"                                                 
#> [13,] "frodo@shire.net"                                                        
#> [14,] "0000-0001-2345-6789"                                                    
#> [15,] "sauron"                                                                 
#> [16,] "the dark side"                                                          
#> [17,] "sauron@mordor.net"                                                      
#> [18,] "0000-0001-2345-678X"                                                    
#> [19,] "[MS, MS:1001834, LC-MS label-free quantitation analysis, ]"             
#> [20,] "MS"                                                                     
#> [21,] "PSI-MS controlled vocabulary"                                           
#> [22,] "4.1.138"                                                                
#> [23,] "https://www.ebi.ac.uk/ols4/ontologies/ms"                               
#> [24,] "PRIDE"                                                                  
#> [25,] "PRIDE PRoteomics IDEntifications (PRIDE) database controlled vocabulary"
#> [26,] "16:10:2023 11:38"                                                       
#> [27,] "https://www.ebi.ac.uk/ols/ontologies/pride"                             
#> [28,] "STATO"                                                                  
#> [29,] "General purpose STATistics Ontology"                                    
#> [30,] "2026-04-20"                                                             
#> [31,] "https://www.ebi.ac.uk/ols4/ontologies/stato"                            
#> [32,] "[,, \"no database\", null ]"                                            
#> [33,] "null"                                                                   
#> [34,] "Unknown"                                                                
#> [35,] "null"                                                                   
#> [36,] "[PRIDE, PRIDE:0000330, Arbitrary quantification unit, ]"                
#> [37,] "[PRIDE, PRIDE:0000330, Arbitrary quantification unit, ]"                
#> [38,] "[MS, MS:1002896, compound identification confidence level, ]"           
...
#> [71,] "study_variable[11]"                        
#> [72,] "study_variable[11]-assay_refs"             
#> [73,] "study_variable[11]-average_function"       
#> [74,] "study_variable[11]-variation_function"     
#> [75,] "study_variable[11]-description"            
#> [76,] "study_variable[12]"                        
#> [77,] "study_variable[12]-assay_refs"             
#> [78,] "study_variable[12]-average_function"       
#> [79,] "study_variable[12]-variation_function"     
#> [80,] "study_variable[12]-description"            
#>       [,2]                                                                                                          
#>  [1,] "[,,time_point,]"                                                                                             
...
#>  [6,] "[,,genotype,]"                                                                                               
#>  [7,] "Sample matrix column genotype"                                                                               
#>  [8,] "[STATO, STATO:0000252, categorical variable, ]"                                                              
#>  [9,] "xsd:string"                                                                                                  
#> [10,] "study_variable[3]|study_variable[4]"                                                                         
#> [11,] "[,,cell_count,]"                                                                                             
#> [12,] "Sample matrix column cell_count"                                                                             
#> [13,] "[STATO, STATO:0000251, continuous variable, ]"                                                               
#> [14,] "xsd:decimal"                                                                                                 
#> [15,] "study_variable[5]|study_variable[6]|study_variable[7]|study_variable[8]|study_variable[9]|study_variable[10]"
#> [16,] "[,,operator,]"                                                                                               
#> [17,] "Sample matrix column operator"                                                                               
#> [18,] "[STATO, STATO:0000252, categorical variable, ]"                                                              
#> [19,] "xsd:string"                                                                                                  
#> [20,] "study_variable[11]|study_variable[12]"                                                                       
#> [21,] "0"                                                                                                           
#> [22,] "assay[1]|assay[3]|assay[5]"                                                                                  
#> [23,] "[MS, MS:1002962, mean, ]"                                                                                    
#> [24,] "[MS, MS:1002963, variation coefficient, ]"                                                                   
#> [25,] "Variable time_point, value 0"                                                                                
#> [26,] "6"                                                                                                           
#> [27,] "assay[2]|assay[4]|assay[6]"                                                                                  
#> [28,] "[MS, MS:1002962, mean, ]"                                                                                    
#> [29,] "[MS, MS:1002963, variation coefficient, ]"                                                                   
#> [30,] "Variable time_point, value 6"                                                                                
#> [31,] "WT"                                                                                                          
#> [32,] "assay[1]|assay[2]"                                                                                           
#> [33,] "[MS, MS:1002962, mean, ]"                                                                                    
#> [34,] "[MS, MS:1002963, variation coefficient, ]"                                                                   
#> [35,] "Variable genotype, value WT"                                                                                 
#> [36,] "KO"                                                                                                          
#> [37,] "assay[3]|assay[4]|assay[5]|assay[6]"                                                                         
#> [38,] "[MS, MS:1002962, mean, ]"                                                                                    
#> [39,] "[MS, MS:1002963, variation coefficient, ]"                                                                   
#> [40,] "Variable genotype, value KO"                                                                                 
#> [41,] "13000"                                                                                                       
#> [42,] "assay[1]"                                                                                                    
...
#> [50,] "Variable cell_count, value 8700"                                                                             
#> [51,] "10100"                                                                                                       
#> [52,] "assay[3]"                                                                                                    
#> [53,] "[MS, MS:1002962, mean, ]"                                                                                    
#> [54,] "[MS, MS:1002963, variation coefficient, ]"                                                                   
#> [55,] "Variable cell_count, value 10100"                                                                            
#> [56,] "6000"                                                                                                        
#> [57,] "assay[4]"                                                                                                    
#> [58,] "[MS, MS:1002962, mean, ]"                                                                                    
#> [59,] "[MS, MS:1002963, variation coefficient, ]"                                                                   
#> [60,] "Variable cell_count, value 6000"                                                                             
#> [61,] "14000"                                                                                                       
#> [62,] "assay[5]"                                                                                                    
#> [63,] "[MS, MS:1002962, mean, ]"                                                                                    
#> [64,] "[MS, MS:1002963, variation coefficient, ]"                                                                   
#> [65,] "Variable cell_count, value 14000"                                                                            
#> [66,] "4500"                                                                                                        
#> [67,] "assay[6]"                                                                                                    
#> [68,] "[MS, MS:1002962, mean, ]"                                                                                    
#> [69,] "[MS, MS:1002963, variation coefficient, ]"                                                                   
#> [70,] "Variable cell_count, value 4500"                                                                             
#> [71,] "BB"                                                                                                          
#> [72,] "assay[1]|assay[2]|assay[3]|assay[4]"                                                                         
#> [73,] "[MS, MS:1002962, mean, ]"                                                                                    
#> [74,] "[MS, MS:1002963, variation coefficient, ]"                                                                   
#> [75,] "Variable operator, value BB"                                                                                 
#> [76,] "FB"                                                                                                          
#> [77,] "assay[5]|assay[6]"                                                                                           
#> [78,] "[MS, MS:1002962, mean, ]"                                                                                    
#> [79,] "[MS, MS:1002963, variation coefficient, ]"                                                                   
#> [80,] "Variable operator, value FB"                                                                                 
